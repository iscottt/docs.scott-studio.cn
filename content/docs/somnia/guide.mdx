---
title: 主题介绍
description: 欢迎使用 Somnia主题 - 一款感受文字温暖的主题
icon: Rocket
---
...
Somnia 主题现分为三个版本，包含`Somnia Simple`、`Somnia Lite`、`Somnia Pro`。基础版可免费使用，只包含基础博客功能。
...
![anchor text](/imgs/checkin.png)

## 主题效果

更多主题效果请访问开发者本人的博客站点：[SCOTT Studio](https://blog.scott-studio.cn)
...
<Callout title="赠品须知" type="warning">
